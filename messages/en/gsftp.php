...
return [
    ...
    'Could not login to SFTP server "{host}" on port "{port}" with user "{user}" using RSA key.' => '',
    'Could not login to SFTP server "{host}" on port "{port}" with user "{user}".' => '',
    'Could not login to SFTP server "{host}" on port "{port}" without username.' => '',
    ...
    '{keyType} key file "{keyFile}" could not be read.' => '',
    '{keyType} key file "{keyFile}" does not exists.' => '',
];
